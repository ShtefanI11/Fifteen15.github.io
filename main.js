...
canvas.addEventListener("click", (e) => { 
  let clickPos;
  if (e.offsetY < 110) clickPos = setClickPos(checkPlace(e.offsetX), 1)
  if (e.offsetY > 110 && e.offsetY < 210) clickPos = setClickPos(checkPlace(e.offsetX), 2)
  if (e.offsetY > 210 && e.offsetY < 310) clickPos = setClickPos(checkPlace(e.offsetX), 3)
  if (e.offsetY > 310 && e.offsetY < 410) clickPos = setClickPos(checkPlace(e.offsetX), 4)
